...
def parse_opts():
    ...
    parser.add_argument(
        '--frame_dir',
        default='/mnt/data/lxj/twostream/flow',
        type=str,
        help='path of jpg files')
    parser.add_argument(
        '--annotation_path',
        default='/mnt/data/lxj/MARS/dataset/ucfTrainTestlist/',
        type=str,
        help='label paths')
    parser.add_argument(
        '--dataset',
    ...
    parser.add_argument(
        '--result_path_MARS',
        default='/mnt/data/lxj/twostream/humdb51double_1_50/MARS/',
        type=str,
        help='result_path')
    parser.add_argument(
        '--result_path_Flow',
        default='/mnt/data/lxj/twostream/humdb51double_1_50/Flow/',
        type=str,
        help='result_path')
    parser.add_argument(
        '--MARS', 
